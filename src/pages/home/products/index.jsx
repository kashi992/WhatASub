...
const Products = () => {
  return (
    <section>
        ...
        <h2 className="text-black leading-none md:py-4 py-2 border-b-[1px] border-[#E41D1D] w-fit font-bold min-[1370px]:text-[40px] md:text-[30px] text-[22px] xl:mb-10 mb-6">
